...
export default function Home() {
  return (
    <main className="min-h-screen overflow-x-clip bg-[var(--surface-bg)] text-[var(--surface-text)]">
      ...
      <footer className="border-t border-rule bg-[var(--surface-bg)] px-5 py-14">
          ...
          <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <Image
                ...
                style={{ width: "auto" }}
              />
              <p className="mt-3 max-w-[280px] text-[13px] leading-relaxed text-text-muted">
                Cognitive DevOps engineer for teams that ship without a dedicated ops team.
              </p>
            </div>

            <div className="flex flex-col gap-5 text-[13px] sm:items-end">
              <div className="flex flex-col gap-2 sm:items-end">
                <a
                  className="text-text-muted transition-micro hover:text-text-mid"
                  href="mailto:adisubu.2410@gmail.com"
                >
                  adisubu.2410@gmail.com
                </a>
                <a
                  className="text-text-muted transition-micro hover:text-text-mid"
                  href="mailto:hello@ssai.dev"
                >
                  hello@ssai.dev
                </a>
              </div>
              <div className="flex items-center gap-4">
                ...
                <a
                  href="https://linkedin.com/in/avinier"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="SSAI on LinkedIn"
                  className="text-text-muted transition-micro hover:text-text-mid"
                >
                  <svg className="h-[16px] w-[16px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
